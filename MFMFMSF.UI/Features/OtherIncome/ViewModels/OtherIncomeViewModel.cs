...
namespace MFMFMSF.UI.Features.OtherIncome.ViewModels
{
    public class OtherIncomeViewModel : INotifyPropertyChanged
    {
        private readonly INavigationService _navigationService;
        private readonly IGivingService _givingService;

        public OtherIncomeViewModel(INavigationService navigationService, IGivingService givingService)
        {
        ...
        public async Task LoadDataAsync()
        {
            ...
            Givings = await _givingService.GetByMonthAndYearAsync(SelectedMonth, SelectedYear, "Other Income", 1, 10);
        }
