...
namespace MFMFMSF.UI.Features.Seeds.ViewModels
{
    public class SeedsViewModel : INotifyPropertyChanged
    {
        ...
        public SeedsViewModel(INavigationService navigationService, IGivingService givingService)
        {
        ...
        public async Task LoadDataAsync()
        {
            ...
            Givings = await _givingService.GetByMonthAndYearAsync(SelectedMonth, SelectedYear, "Seed", 1, 10);
        }
